...
class NvcompDeflateLibrary : public GpuCompressionLibrary {
 private:
  NvcompTemplate<nvcompBatchedDeflateOpts_t>* nvcomp_;

  size_t chunk_size_;
  nvcompBatchedDeflateOpts_t configuration_;
 ...
 public:
  ...
  NvcompDeflateLibrary(const uint64_t& batch_size = 1000);
  ~NvcompDeflateLibrary();
};
