...
bool NvcompSnappyLibrary::CheckOptions(GpuOptions *options,
  ...
  if (result) {
    if ((result = GpuCompressionLibrary::CheckChunkNumber("nvcomp-snappy",
                                                          options, 4, 13))) {
      if ((result = GpuCompressionLibrary::CheckStreamNumber("nvcomp-snappy",
                                                             options, 1, 8))) {
...
void NvcompSnappyLibrary::GetCompressedDataSize(
...
bool NvcompSnappyLibrary::CompressDeviceToDevice(
...
bool NvcompSnappyLibrary::CompressHostToDevice(
...
bool NvcompSnappyLibrary::CompressDeviceToHost(
    const char *const device_uncompressed_data,
...
bool NvcompSnappyLibrary::CompressHostToHost(
    const char *const host_uncompressed_data,
    const uint64_t &uncompressed_data_size, char *host_compressed_data,
    uint64_t *compressed_data_size) {
  bool result{initialized_compressor_};
...
bool NvcompSnappyLibrary::DecompressDeviceToDevice(
    const char *const device_compressed_data,
...
bool NvcompSnappyLibrary::DecompressDeviceToHost(
    const char *const device_compressed_data,
...
bool NvcompSnappyLibrary::DecompressHostToDevice(
...
bool NvcompSnappyLibrary::DecompressHostToHost(
    const char *const host_compressed_data,
    const uint64_t &compressed_data_size, char *host_decompressed_data,
    uint64_t *decompressed_data_size) {
  bool result{initialized_decompressor_};
...
void NvcompSnappyLibrary::GetTitle() {
  GpuCompressionLibrary::GetTitle("nvcomp-snappy",
                                  "Similar to LZ4, this byte-level "
                                  "compressor is a popular existing format "
...
bool NvcompSnappyLibrary::GetChunkNumberInformation(
...
bool NvcompSnappyLibrary::GetStreamNumberInformation(
...
NvcompSnappyLibrary::NvcompSnappyLibrary() {
  nvcomp_ = new NvcompTemplate<nvcompBatchedSnappyOpts_t>(
      ...
      nvcompBatchedSnappyCompressAsync, nvcompBatchedSnappyDecompressAsync);
}
